...
const CUSTOM_MATCAP = () => makeMatcap([
  [0.00, BRAND.lilac],
  [0.30, BRAND.lavender],
  [0.60, BRAND.indigo],
  [0.85, '#070160'],
...
const ORB_JOURNEY = [
  ...
  { p: 0.00, x:   42, y:   -4, s: 1.55, o: 1.00 },   // hero anchor, right
  { p: 0.06, x:   39, y:   -2, s: 1.50, o: 0.98 },   // drifting in from hero
  { p: 0.12, x:   33, y:   -3, s: 1.45, o: 0.95 },   // approaching center
  { p: 0.18, x:    0, y:   -3, s: 1.50, o: 0.92 },   // center, hover beat
  ...
  { p: 1.00, x:    0, y:   40, s: 0.20, o: 0.00 },   // arrived, orb gone, mark visible
];
