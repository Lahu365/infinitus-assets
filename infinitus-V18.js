...
const ORB_JOURNEY = [
  ...
  { p: 0.06, x: 34, y: -2, s: 1.5, o: 0.98 }, // drifting in from hero
  { p: 0.12, x: 16, y: 0, s: 1.45, o: 0.95 }, // approaching center
  { p: 0.18, x: 16, y: 2, s: 0.65, o: 0.92 }, // center, hover beat
  { p: 0.22, x: -22, y: 5, s: 0.65, o: 0.9 }, // drifting left, building
  { p: 0.27, x: -26, y: 6, s: 0.65, o: 0.88 }, // left peak, behind the pillar cards
  { p: 0.36, x: -20, y: 9, s: 0.65, o: 0.88 }, // returning toward center, still bright
  { p: 0.42, x: -15, y: 8, s: 0.65, o: 0.85 }, // exhale, mid size, settling
  { p: 0.52, x: 8, y: 5, s: 0.92, o: 0.85 }, // wandering through center, sinking
  { p: 0.62, x: 24, y: -2, s: 0.78, o: 0.88 }, // small, right, lifts
  { p: 0.72, x: -7, y: 21, s: 0.75, o: 0.88 }, // small, near center, sinks
  { p: 0.82, x: 12, y: -1, s: 0.95, o: 0.92 }, // CTA, medium, slight lift
  { p: 0.88, x: 5, y: 14, s: 0.65, o: 0.82 }, // begins falling toward the footer mark
